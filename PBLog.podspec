#
# Be sure to run `pod spec lint PBLog.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of PBLog
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Piet" => "piet@nerdishbynature.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Piet', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/nerdishbynature/PBLog", :tag => "0.0.1" }
